/* autogenerated by Processing revision 1297 on 2025-03-26 */
...
public void draw() {
  ...
  scale(0.90f, 0.90f);    // shrinks the drawing within the display screen.
  translate(64, 36.0f);  // gives a small border around drawing.
